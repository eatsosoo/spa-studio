...
export const adminResources: Record<AdminResourceConfig['resource'], AdminResourceConfig> = {
  ...
  employees: {
    ...
    description: 'Chức danh, ca làm và trạng thái hiện tại của từng thành viên. Tài khoản đăng nhập và vai trò truy cập được quản lý tại mục Tài khoản & phân quyền.',
    ...
    fields: [
      ...
      { key: 'role', label: 'Chức danh', type: 'select', options: ['Kỹ thuật viên', 'Lễ tân', 'Quản lý', 'Tư vấn viên'] },
